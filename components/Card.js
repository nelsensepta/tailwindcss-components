export default function Card() {
  return (
    <div className="bg-white shadow-xl hover:shadow rounded-lg overflow-hidden transform rotate-3 hover:rotate-0 transition-all duration-200">
      <div className="px-8 py-5 leading-relaxed text-xl text-gray-800">
        <svg
          width="45"
          height="36"
          className="mb-5 fill-current text-light-blue-200"
        >
        ...
        <div className="flex items-center">
          <div className="flex-shrink-0 mr-3">
            <img
              ...
              src="https://images.unsplash.com/photo-1621472124503-a760c1146f44?ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDR8NnNNVmpUTFNrZVF8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=60"
            />
          </div>
          <div className="text-white">Kucir</div>
        </div>
        <a
          href="#"
